...
@section('content')
    ...
    <div class="brand-header">
        <div class="container">
            ...
            <p>{{ trans_lang('تصفح جميع منتجات الماركة', 'Browse all brand products') }}</p>
        </div>
    </div>
    ...
    <img src="{{ $firstImage ? asset('uploads/' . $firstImage->image) : asset('images/no-image.png') }}"
        ...
        @empty
            ...
            <div class="empty-brand">
                ...
                <p>{{ trans_lang('لا توجد منتجات متاحة لهذه الماركة حالياً', 'No products available for this brand yet') }}</p>
